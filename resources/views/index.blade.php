...
html {
  ...
  .card {
    ...
    .card__picture {
      ...
      .card__picture--1 {
        background-image: linear-gradient(to right bottom, lightseagreen,coral), url(https://yt3.ggpht.com/a-/AN66SAwpXgcHQRYmQX7adjuXjkk5RfTvWVXOb1oViQ=s900-mo-c-c0xffffffff-rj-k-no); }
      .card__picture--2 {
...
@extends('layouts.app')
      ...
      <div class="flexslider left" >
      	<ul class="slides">
      		<li>
      			<img src="https://scontent.fdac48-1.fna.fbcdn.net/v/t1.0-9/42344318_323737448175435_1015472221738500096_n.png?_nc_cat=108&_nc_oc=AQnLJKn7UGfN4ltdw5TfVSc1t3fQEXiJ6L0T0_NV7kqXYKVszyqauLe5aN6H4F1l76w&_nc_ht=scontent.fdac48-1.fna&oh=2cebc89edcb0767ff575eaf173b2707f&oe=5DDC11EE" height="500px">
      			<div class="meta">
      				<h1>R_Bit</h1>
      				<h2>We are the Titans.</h2>
      				<div class="category">
      					<p>Tech</p>
      					<span>Power</span>
      				</div>
      		...
      		<li>
      			<img src="https://rockresearch.com/wp-content/uploads/2017/11/event_technology.jpg" height="500px">
      			<div class="meta">
      				<h1>R_Bit</h1>
      				<h2>Let the World be in our hand</h2>
      				<div class="category">
      					<p>Intervention</p>
      					<span>World</span>
      				</div>
      		...
      		<li>
      			<img src="http://blog.apaonline.org/wp-content/uploads/2016/05/technology1.jpg" height="500px">
      			<div class="meta">
      				<h1>R_Bit</h1>
      				<h2>Power Of Microns.</h2>
      				<div class="category">
      					<p>Micro</p>
      					<span>Burger</span>
      				</div>
      		...
      		<li>
      			<img src="https://thumbs.dreamstime.com/z/online-security-technology-background-40026802.jpg" height="500px">
      			<div class="meta">
      				<h1>R_Bit</h1>
      				<h2>The kings of the Net</h2>
      				<div class="category">
      					<p>Hacker</p>
      					<span>Lords</span>
      				</div>
                    ...
                    <div class="card">
                        <div class="card__side card__side--front">
                            ...
                            <div class="card__details">
                                <ul>
                                    <li>Selfier</li>
                                    <li>Best photograyher in the world
                                    Lets Rock</li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="card__cta">
                                <div class="card__price-box">
                                    <p class="card__price-only">
                                      Best photograyher in the world<br>
                                      Best photograyher in the world
                                    </p>
                ...
                <div class="col-1-of-3">
                    <div class="card">
                        ...
                        <div class="card__side card__side--back card__side--back-2">
                            <div class="card__cta">
                                <div class="card__price-box">
                                    <p class="card__price-only">We are the best Club.We are the best Club.We are the best Club</p>
                            ...
                            <div class="card__cta">
                                <div class="card__price-box">
                                    <p class="card__price-only">
                                      ...
                                      <br>we fear no one.<br>we fear no one.<br>we fear no one.
                                      <br>we fear no one.
                                    </p>
                                    <p class="card__price-value">Selfie</p>
                                </div>
